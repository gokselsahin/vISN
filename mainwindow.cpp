...
void MainWindow::setupTGraph()
{
    ...
    ui->tTestGraph->yAxis->setLabel("Kabin Sıcaklıgı (°C)");
        ...
        ui->tTestGraph->yAxis2->setLabel("Nem (%Rh)");
    ...
    ui->tTestGraph->yAxis->setRange(-40, 180.0);
        ui->tTestGraph->yAxis2->setRange(0, 100);
...
void MainWindow::setupVisuals()
{
   ...
   //
    ...
    ui->leFixHumidtyValue->setEnabled(false); // fix mod nem kapalı
...
void MainWindow::mouseWheel()
{
    ...
    if (ui->tTestGraph->yAxis2->range().upper > 100 || ui->pTestGraph->yAxis2->range().upper < 0 )
    {

         ui->tTestGraph->yAxis2->setRange(0,100);
         ui->tTestGraph->yAxis2->range().bounded(0,100);
         ui->tTestGraph->replot();
    }
...
void MainWindow::on_ZoomOutVer_clicked()                              // Grafik sayfası yatay zoom - butonuna basıldı
{
    ...
    ui->pTestGraph->yAxis->setRangeLower(0);
    ui->pTestGraph->replot();
    if (ui->pTestGraph->yAxis->range().upper > 100 || ui->pTestGraph->yAxis->range().upper < 0 )
    {
         ui->pTestGraph->yAxis->setRange(0,100);
    ...
    ui->tTestGraph->yAxis2->setRangeLower(0);
    if (ui->tTestGraph->yAxis2->range().upper > 100 || ui->tTestGraph->yAxis2->range().upper < 0 )
    {
         ui->tTestGraph->yAxis2->setRange(0,100);
...
void MainWindow::on_cbSelectProfileMain_currentIndexChanged(int index)      //  Ana Sayfada "Bir Test Recetesi Seciniz" açılan kutusu değişti.
{
 ...
 //       quint8 index = ui->cbSelectProfileMain->currentIndex();
        ...
        {
               ui->laSelectedProfileMain->setText(tProfileLoad[index].name);
               ui->laTestName->setText(tProfileLoad[index].name);
      ...
      //          ui->sbTTotalCycle->setEnabled(false);
       ...
       //         ui->sbTTotalCycle->setEnabled(true);
                ...
                {
                   if (tProfileLoad[index].step[0].stepUnit == 2 )
                   {
      ...
      //          ui->laTotalTestSecond->setText(QString::number(totalTestDuration)) ;
                ...
                ui->pb_testProgress->setMaximum(totalTestDuration);
            }
        }
    }
...
{
    if((ui->leHumidity_0->text().toDouble() > 95 || ui->leHumidity_0->text().toDouble() < 20) && ui->leHumidity_0->text().toDouble() != 0.00 )
    {
        QMessageBox::information(
                    this,
                    tr(appName),
                    tr("nem degeri 20-95 arasinda olmalidir.") );
        ui->leHumidity_0->setText("0");



    }  if((ui->leHumidity_1->text().toDouble() >= 95 || ui->leHumidity_1->text().toDouble() <= 20) && ui->leHumidity_1->text().toDouble() != 0.00)
    {
    ...
    }   if((ui->leHumidity_2->text().toDouble() >= 95 || ui->leHumidity_2->text().toDouble() <= 20 )&& ui->leHumidity_2->text().toDouble() != 0.00)
    {
    ...
    } if((ui->leHumidity_3->text().toDouble() >= 95 || ui->leHumidity_3->text().toDouble() <= 20) && ui->leHumidity_3->text().toDouble() != 0.00)
    {
        QMessageBox::information(
                    this,
                    tr(appName),
    ...
    }  else if((ui->leHumidity_4->text().toDouble() >= 95 || ui->leHumidity_4->text().toDouble() <= 20) && ui->leHumidity_4->text().toDouble() != 0.00)
    {
        QMessageBox::information(
                    this,
                    tr(appName),
    ...
    }  if((ui->leHumidity_5->text().toDouble() >= 95 || ui->leHumidity_5->text().toDouble() <= 20) && ui->leHumidity_5->text().toDouble() != 0.00 )
    {
        QMessageBox::information(
                this,
                    tr(appName),
    ...
    }   if((ui->leHumidity_6->text().toDouble() >= 95 || ui->leHumidity_6->text().toDouble() <= 20) && ui->leHumidity_6->text().toDouble() != 0.00)
    {
        QMessageBox::information(
                    this,
                    tr(appName),
    ...
    }   if((ui->leHumidity_7->text().toDouble() >= 95 || ui->leHumidity_7->text().toDouble() <= 20 )&& ui->leHumidity_7->text().toDouble() != 0.00)
    {
        QMessageBox::information(
                    this,
                    tr(appName),
    ...
    }   if((ui->leHumidity_8->text().toDouble() >= 95 || ui->leHumidity_8->text().toDouble() <= 20 )&& ui->leHumidity_8->text().toDouble() != 0.00)
    {
        QMessageBox::information(
                    this,
                    tr(appName),
    ...
    }   if((ui->leHumidity_9->text().toDouble() >= 95 || ui->leHumidity_9->text().toDouble() <= 20) && ui->leHumidity_9->text().toDouble() != 0.00 )
    {
        QMessageBox::information(
                    this,
                    tr(appName),
    ...
    }   if((ui->leHumidity_10->text().toDouble() >= 95 || ui->leHumidity_10->text().toDouble() <= 20 ) && ui->leHumidity_10->text().toDouble() != 0.00)
    {
        QMessageBox::information(
                    this,
                    tr(appName),
    ...
    }  if((ui->leHumidity_11->text().toDouble() >= 95 || ui->leHumidity_11->text().toDouble() <= 20) && ui->leHumidity_11->text().toDouble() != 0.00)
    {
        QMessageBox::information(
                    this,
                    tr(appName),
    ...
    }   if((ui->leHumidity_12->text().toDouble() >= 95 || ui->leHumidity_12->text().toDouble() <= 20 )&& ui->leHumidity_12->text().toDouble() != 0.00)
    {
        QMessageBox::information(
                    this,
                    tr(appName),
    ...
    }   if((ui->leHumidity_13->text().toDouble() >= 95 || ui->leHumidity_13->text().toDouble() <= 20) && ui->leHumidity_13->text().toDouble() != 0.00)
    {
        QMessageBox::information(
                    this,
                    tr(appName),
    ...
    }   if((ui->leHumidity_14->text().toDouble() >= 95 || ui->leHumidity_14->text().toDouble() <= 20 )&& ui->leHumidity_14->text().toDouble() != 0.00 )
    {
        QMessageBox::information(
                    this,
                    tr(appName),
...
void MainWindow::on_cbChooseProfileTypeNew_currentIndexChanged(int index)
{
    if(ui->cbChooseProfileTypeNew->currentIndex() == 0)
    {
        ui->leHumidity_0->setEnabled(false);
...
void MainWindow::on_leFixTempValue_textChanged(const QString &arg1)
{
    if(ui->leFixTempValue->text().toDouble() > 120  || ui->leFixTempValue->text().toDouble() < -40)
    {
        QMessageBox::information(
                    this,
                    tr(appName),
                    tr("120 dereceden fazla sicaklik girilemez") );
        ui->leFixTempValue->setText(" ");
...
void MainWindow::on_leFixHumidtyValue_textChanged(const QString &arg1)
{

    /*  if(ui->leFixHumidtyValue->text().toDouble() > 95 || ui->leFixHumidtyValue->text().toDouble() < 20)
    {
        QMessageBox::information(
                    this,
                    tr(appName),
                    tr("nem degeri 20-95 %rh arasında olmalıdır.") );
        ui->leFixHumidtyValue->setText(" ");
...
void MainWindow::on_leFixHumidtyValue_editingFinished()
{
    if(ui->leFixHumidtyValue->text().toDouble() > 95 || ui->leFixHumidtyValue->text().toDouble() < 20)
    {
        QMessageBox::information(
                    ...
                    tr(appName),
                    tr("nem degeri 20-95 %rh arasında olmalıdır.") );
        ui->leFixHumidtyValue->setText("20");
...
void MainWindow::on_cbFixMode_currentIndexChanged(int index)
{
    if(ui->cbFixMode->currentIndex() == 1)
      {
          ui->leFixHumidtyValue->setEnabled(true);
      }
    if(ui->cbFixMode->currentIndex() == 0)
